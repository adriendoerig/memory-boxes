function [err] = errorFitBoxesNoNDtime(p, data, stimType)
...
% p(6) = wongWang_mu0
    ...
    pT = pTransformNoNDtime(p); %Transforms the parameter vector such that all values to optimize vary between 0 and 1.
    ...
    for i = 1:conds
        ...
        for n = 1:nTrials
            [decisions{i}(n), modelRTs{i}(n), success] = runTrial(1, stimuli{i}, dt, ...
                0, pT(1), pT(2), pT(3), pT(4), pT(5), pT(6));
